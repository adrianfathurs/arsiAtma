...
<!-- <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
    ...
    <div id="carousel-items" class="carousel-item active" data-interval="1000">
        <img class="image-carousel-size" src="<?php echo base_url('assets/')?>img/courses/c1.jpg"   style="width: 100%; max-height: 550px"  alt="...">  </img>
    </div>
...
<div id="main-wrapper">
   <h2 class="text-white">TENTANG HIMPUNAN MAHASISWA ARSITEKTUR ATMA JAYA YOGYAKARTA</h2>
   
   <hr>
   <br>
   <center><h3 class="text-white"><b><span>-- </span> TRICAKA <span> --</span></b></h3></center>
   <br>
