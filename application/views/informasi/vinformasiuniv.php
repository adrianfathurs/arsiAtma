            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="col-md">
                        ...
                        <?php if( $type_akun=="1"){ ?>                       
                        <a href="<?php echo base_url('informasi/formuniv/') ?>" class="btn waves-effect waves-light btn-success">Tambah</a>
                        <?php }; ?>
                        </div>
                    </div>
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    ...
                                    <div class="blog_details">
                                        <a href="<?php echo base_url('Informasi/informasi_detail/').$informasi->id_informasi_univ ;?>">
                                            <h2><?php echo $informasi->judul_univ; ?></h2>
                                        </a>
                                        <p><?php echo UCWORDS(substr($informasi->deskripsi_univ, 0, 300)) . '...'; ?></p>
                                        <a href="<?php echo base_url('Informasi/informasi_detail/').$informasi->id_informasi_univ ;?>" class="blog_btn">View More</a>
                                        <?php if( $type_akun=='1'){ ?>    
